          ...
          <ul class="nav pull-right">
            <li class="dropdown">
            	<a data-toggle="dropdown" class="dropdown-toggle" href="#" title="角色：${groupNames}">
            		<i class="icon-user icon-black" style="margin-right: .3em"></i>${login_user.firstName }&nbsp;${login_user.lastName }/${login_user.id }<b class="caret"></b>
            	</a>
            	<ul class="dropdown-menu">
